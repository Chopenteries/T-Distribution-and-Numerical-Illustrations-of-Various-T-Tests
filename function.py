...
def has_2_samples():
    samples = input("\nDo you know your variables ?\n"
                    ...
                    "population. \n"
                    "\n2: Numerical Illustrations of Various T-Tests \n"
                    ...
                    "'y' for T=-Distribution with known variables")
    return samples
...
def run(which_type):
    # T Distribution and Numerical Illustrations of Various T-Tests has chosen
    if int_exception(which_type) == 2:
        ...
        numerical_illustrations_of_various_t_test(sample_x1, sample_x2)
...
def numerical_illustrations_of_various_t_test(x1, x2):
    # variables
